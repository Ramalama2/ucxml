<?php
/*
	UCxml web Portal - My Account contact
...
if (isset($_POST['action']))
{
	...
	if ($myAction == "edit" )
	{
  		if (isset($_POST['submit_save_contact']))
		{
			...
			header("Location: index.php?module=my_account_contact");// Saving
			}
	...
	output_edit_user($tmp_id_contact);
	render_Footer();
}

//Create page and fill in known data
function output_edit_user ($myID_contact)
{
	include "language/lang.php";
	global $db, $xtpl, $delete;
	$xtpl=new XTemplate ("modules/templates/my_account_contact.html");
